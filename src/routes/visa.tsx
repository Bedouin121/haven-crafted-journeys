  ...
  return (
    <VisaCatalog
      ...
      copy={{
        ...
        intro:
          "Tourist visa requirements change, appointments are hard to get, and the wrong document can delay your trip. Upscale Travel takes it off your plate — from document review to embassy submission and approval tracking.",
