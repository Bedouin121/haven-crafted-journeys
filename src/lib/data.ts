...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    country: "Nepal",
    region: "Asia",
    tagline: "Himalayan peaks, ancient temples, and the world's greatest trekking",
    description:
      "Kathmandu's ancient Durbar Squares give way to high-altitude trails where the Himalayas dominate the horizon. Nepal is a country of extraordinary contrasts — bustling bazaars at dawn, Himalayan silence by afternoon.",
    ...
    gallery: [
      ...
      U("photo-1571827338256-e4cec1c7e1c6"),
    ],
    highlights: [
      "Sunrise view of Everest from Kala Patthar",
      "Guided tour of Pashupatinath and Boudhanath",
      "White-water rafting on the Trishuli River",
      "Paragliding above Pokhara's Phewa Lake",
    ],
  ...
  },
  {
    ...
    country: "Bhutan",
    region: "Asia",
    tagline: "The last Himalayan kingdom — monasteries, mountains, and happiness",
    description:
      "Bhutan measures progress in Gross National Happiness, not GDP. Tiger's Nest clings to a cliff face 3,000 metres above sea level, the valleys are carpeted in prayer flags, and the pace of life is exactly what you needed.",
    ...
    gallery: [
      ...
      U("photo-1509099836639-18ba1795216d"),
      U("photo-1585409677983-0f6c41ca9c3b"),
      U("photo-1562602833-0f4ab2fc46e5"),
    ],
    highlights: [
      "Hike to Tiger's Nest Monastery (Paro Taktsang)",
      "Punakha Dzong at the river confluence",
      "Traditional Bhutanese hot stone bath",
      "Archery competition in a local village",
    ],
  ...
  },
  {
    ...
    country: "Maldives",
    region: "Asia",
    tagline: "Overwater bungalows, coral reefs, and a horizon of ocean blue",
    description:
      "The Maldives is one of the world's flattest nations and one of its most spectacular — a thousand coral islands, overwater villas, and the kind of water clarity that makes snorkelling feel like flying.",
    bestTime: "November – April",
    duration: "5 – 10 nights",
    fromPrice: 88000,
    image: U("photo-1573843981267-be1999ff37cd"),
    gallery: [
    ...
    highlights: [
      "Sunrise snorkel on a house reef",
      "Sunset dolphin cruise",
      "Sri Lanka day trip from Malé",
      "Underwater dining at a resort restaurant",
    ],
...
export const packages: Package[] = [
  {
    ...
    itinerary: [
      ...
      { day: 7, title: "Farewell", body: "Slow breakfast, transfer to Suvarnabhumi for onward flights." },
    ],
  },
  {
    ...
    image: "/images/Tourist-Visas/malaysia-tourist.png",
    summary:
      "Three nights across Kuala Lumpur, Penang, and the Cameron Highlands — rainforest canopy walks, hawker lanes, and tea country.",
    inclusions: [
    ...
    itinerary: [
      ...
      { day: 2, title: "Old KL & Batu Caves", body: "Chinatown, Merdeka Square, sunrise visit to Batu Caves." },
      { day: 3, title: "North to Penang", body: "Flight to George Town, guided hawker food walk." },
      { day: 4, title: "Farewell", body: "Slow morning in Penang, transfer to the airport." },
    ],
  },
  {
    ...
    image: "/images/Tourist-Visas/singapore-tourist.png",
    summary:
      "Three nights of curated Singapore — hawker centres, botanic mornings, chef's tables, and rooftop views over Marina Bay.",
    inclusions: [
      "Three nights at a 4-star hotel near Marina Bay",
    ...
    itinerary: [
      ...
      { day: 3, title: "Green Singapore", body: "Botanic Gardens at dawn, Gardens by the Bay after sunset." },
      { day: 4, title: "Farewell", body: "Slow morning, private transfer to Changi." },
    ],
  },
  {
    ...
    image: "/images/Tourist-Visas/china-tourist.png",
    summary:
      "Five nights across Beijing, Xi'an, and Shanghai — with private access at the moments that matter.",
    inclusions: [
      "4-star hotel in Beijing",
      "Sunrise hike on the Great Wall",
    ...
    itinerary: [
      ...
      { day: 2, title: "Forbidden City", body: "Guided morning visit, afternoon at the Temple of Heaven." },
      { day: 3, title: "The Wall", body: "Sunrise hike on the Great Wall at Mutianyu." },
      { day: 4, title: "Xi'an", body: "Flight south, evening at the Muslim Quarter night market." },
      { day: 5, title: "Terracotta Warriors & Departure", body: "Morning visit to the Warriors, transfer to the airport." },
    ],
  },
  {
    slug: "usa-southwest",
  ...
  },
  {
    ...
    image: "/images/Tourist-Visas/egypt-tourist.png",
    summary:
      "Four nights between Cairo, the Pyramids of Giza, and Alexandria's Mediterranean shore — with an Egyptologist at your side throughout.",
    inclusions: [
      "4-star hotel in Cairo",
      "Private Egyptologist guide throughout",
      "Early access to the Pyramids of Giza",
      "Alexandria day trip with transport",
      "Daily breakfast",
    ],
    itinerary: [
      { day: 1, title: "Cairo Arrival", body: "Private transfer to a hotel with pyramid views, welcome dinner." },
      { day: 2, title: "Giza & Old Cairo", body: "Pyramids at dawn, Coptic quarter, Khan el-Khalili at dusk." },
      { day: 3, title: "Alexandria", body: "Day trip to the Mediterranean coast — Bibliotheca, Corniche, seafood lunch." },
      { day: 4, title: "Cairo Museums & Departure", body: "Egyptian Museum in the morning, transfer to the airport." },
    ],
  },
  {
  ...
  // ─── New packages from import data ───────────────────────────────────────
  {
    slug: "china-guangzhou",
    title: "China Guangzhou Tour",
    destination: "China",
    destinationSlug: "china",
    nights: 4,
    price: 84500,
    ...
    image: "/images/Tourist-Visas/china-tourist.png",
    summary:
      "Five days in Guangzhou — the Pearl River at dusk, Canton-ese dim sum from the source, Shamian Island's colonial lanes, and the world's largest trade fair hub.",
    inclusions: [
      "4-star hotel in Guangzhou (4 nights)",
      "Private guide throughout",
      "Canton Fair registration support",
      "Pearl River evening cruise",
      "Daily breakfast",
    ],
    itinerary: [
      { day: 1, title: "Arrival in Guangzhou", body: "Transfer to hotel, evening stroll along the Pearl River." },
      { day: 2, title: "Old Guangzhou", body: "Shamian Island, Chen Clan Ancestral Hall, dim sum breakfast." },
      { day: 3, title: "Canton Tower & Markets", body: "Canton Tower at sunrise, Qingping herbal market, local dinner." },
      { day: 4, title: "Day Trip to Foshan", body: "Ancestral Temple, traditional Cantonese opera, Nanfeng Ancient Kiln." },
      { day: 5, title: "Farewell", body: "Slow breakfast, transfer to Guangzhou Baiyun Airport." },
    ],
  },
  {
    slug: "nepal-highlands",
    title: "Nepal, Peaks & Temples",
    destination: "Nepal",
    ...
    image: U("photo-1506905925346-21bda4d32df4"),
    summary:
      "Six days between Kathmandu's temple squares and the Pokhara valley — Himalayan sunrise viewpoints, ancient Durbar squares, and Phewa Lake reflections.",
    inclusions: [
      "Boutique hotel in Kathmandu & Pokhara",
      "Private guide throughout",
      "Sunrise trek to Sarangkot for Himalayan views",
      "Guided Pashupatinath & Boudhanath tour",
      "Daily breakfast",
    ],
    itinerary: [
      { day: 1, title: "Kathmandu Arrival", body: "Transfer to hotel, evening walk around Thamel." },
      { day: 2, title: "Durbar Squares", body: "Pashupatinath, Boudhanath stupa, Swayambhunath at dawn." },
      { day: 3, title: "Patan & Bhaktapur", body: "Guided tour of the ancient city squares and local craft workshops." },
      { day: 4, title: "Fly to Pokhara", body: "Short mountain flight, afternoon on Phewa Lake by rowboat." },
      { day: 5, title: "Sarangkot Sunrise", body: "Pre-dawn drive to Sarangkot for panoramic Annapurna views." },
      { day: 6, title: "Farewell", body: "Slow breakfast in Pokhara, transfer to Tribhuvan Airport." },
    ],
  },
  {
    slug: "bhutan-kingdom",
    title: "Bhutan, The Last Kingdom",
    destination: "Bhutan",
    ...
    image: U("photo-1552832230-c0197dd311b5"),
    summary:
      "Four nights across Paro and Thimphu — the legendary Tiger's Nest hike, dzong monasteries, traditional hot stone baths, and the world's most serene mountain kingdom.",
    inclusions: [
      "3-star lodge in Paro & Thimphu",
      "Licensed Bhutanese guide throughout",
      "Tiger's Nest hike with guide",
      "Sustainable Development Fee included",
      "All meals (full board)",
    ],
    itinerary: [
      { day: 1, title: "Paro Arrival", body: "Scenic Drukair flight, transfer to lodge, Rinpung Dzong visit." },
      { day: 2, title: "Tiger's Nest", body: "Full-day hike to Paro Taktsang Monastery — the defining Bhutan experience." },
      { day: 3, title: "Thimphu", body: "Drive to the capital — Buddha Dordenma statue, weekend market, Memorial Chorten." },
      { day: 4, title: "Punakha Day Trip", body: "Drive over Dochu La pass to Punakha Dzong at the river confluence." },
      { day: 5, title: "Farewell", body: "Traditional hot stone bath in the morning, transfer to Paro Airport." },
    ],
  },
  {
    slug: "thailand-malaysia-combo",
    title: "Thailand & Malaysia — 5 Days",
    destination: "Thailand",
    destinationSlug: "thailand",
    nights: 4,
    price: 70500,
    ...
    image: "/images/Tourist-Visas/thailand-tourist.png",
    summary:
      "Five days across Bangkok and Kuala Lumpur — street-food capitals back to back, with temples, towers, and hawker lanes connecting them.",
    inclusions: [
      "Hotel in Bangkok (2 nights) & KL (2 nights)",
      "Bangkok–KL flight",
      "Guided food walks in both cities",
      "All airport transfers",
      "Daily breakfast",
    ],
    itinerary: [
      { day: 1, title: "Bangkok Arrival", body: "Transfer, evening Chao Phraya rooftop dinner." },
      { day: 2, title: "Bangkok Temples", body: "Wat Pho at first light, Grand Palace, longtail khlong tour." },
      { day: 3, title: "Fly to Kuala Lumpur", body: "Morning flight, afternoon at Petronas Towers & Chinatown." },
      { day: 4, title: "Kuala Lumpur", body: "Batu Caves at sunrise, Masjid Jamek, guided hawker dinner." },
      { day: 5, title: "Farewell", body: "Slow morning, transfer to KL International Airport." },
    ],
  },
  {
    slug: "singapore-malaysia-combo",
    title: "Singapore & Malaysia — 6 Days",
    destination: "Singapore",
    destinationSlug: "singapore",
    nights: 5,
    price: 87500,
    ...
    image: "/images/Tourist-Visas/singapore-tourist.png",
    summary:
      "Six days between Marina Bay and George Town — world-class hawker food, colonial heritage lanes, and Gardens by the Bay, all in one seamless journey.",
    inclusions: [
      "Hotel in Singapore (3 nights) & Penang (2 nights)",
      "Singapore–Penang flight",
      "Guided hawker walks in both cities",
      "Gardens by the Bay entrance",
      "Daily breakfast",
    ],
    itinerary: [
      { day: 1, title: "Singapore Arrival", body: "Transfer to hotel near Marina Bay, evening on the waterfront." },
      { day: 2, title: "Singapore Classic", body: "Chinatown, Kampong Glam, chef-guided hawker dinner." },
      { day: 3, title: "Gardens & Sentosa", body: "Gardens by the Bay at sunrise, Sentosa Island afternoon." },
      { day: 4, title: "Fly to Penang", body: "Morning flight, afternoon George Town heritage walk." },
      { day: 5, title: "Penang Street Food", body: "Full-day hawker food tour with a local guide." },
      { day: 6, title: "Farewell", body: "Slow morning, transfer to Penang Airport." },
    ],
  },
  {
    slug: "trio-thai-sin-mys",
    title: "Thailand · Singapore · Malaysia — 7 Days",
    destination: "Thailand",
    destinationSlug: "thailand",
    nights: 6,
    price: 89900,
    ...
    image: "/images/Tourist-Visas/thailand-tourist.png",
    summary:
      "The great Southeast Asian trio in one week — Bangkok temples, Singapore's futuristic harbour, and Kuala Lumpur's hawker culture, stitched together by short flights.",
    inclusions: [
      "Hotel in Bangkok, Singapore & KL (2 nights each)",
      "All inter-city flights",
      "Guided city highlights in each destination",
      "All airport transfers",
      "Daily breakfast",
    ],
    itinerary: [
      { day: 1, title: "Bangkok", body: "Arrival, riverside dinner, Chao Phraya at dusk." },
      { day: 2, title: "Bangkok Temples", body: "Wat Pho, Grand Palace, longtail canal tour." },
      { day: 3, title: "Fly to Singapore", body: "Morning flight, afternoon at Gardens by the Bay." },
      { day: 4, title: "Singapore", body: "Hawker centre dinner, Marina Bay Sands rooftop views." },
      { day: 5, title: "Fly to Kuala Lumpur", body: "Morning flight, Petronas Towers & Chinatown." },
      { day: 6, title: "Kuala Lumpur", body: "Batu Caves at dawn, guided hawker walk." },
      { day: 7, title: "Farewell", body: "Slow morning, transfer to KLIA." },
    ],
  },
  {
    slug: "maldives-sri-lanka",
    title: "Maldives & Sri Lanka — 7 Days",
    ...
    image: U("photo-1573843981267-be1999ff37cd"),
    summary:
      "Seven days combining the crystal-clear atolls of the Maldives with Sri Lanka's colonial coast and wildlife — the perfect Indian Ocean pairing.",
    inclusions: [
      "Resort stay in the Maldives (3 nights)",
      "Hotel in Colombo or Galle (3 nights)",
      "Maldives–Sri Lanka flight",
      "Guided Sri Lanka city tour",
      "Daily breakfast",
    ],
    itinerary: [
      { day: 1, title: "Maldives Arrival", body: "Speedboat transfer to resort, sunset on the overwater deck." },
      { day: 2, title: "Reef & Lagoon", body: "Snorkelling on the house reef, dolphin sunset cruise." },
      { day: 3, title: "Maldives — Last Morning", body: "Sunrise swim, seaplane views over the atolls." },
      { day: 4, title: "Fly to Colombo", body: "Flight to Sri Lanka, transfer to Galle Fort." },
      { day: 5, title: "Galle & South Coast", body: "Colonial fort walk, stilt fishermen, whale-watching boat trip." },
      { day: 6, title: "Colombo", body: "Pettah market, Galle Face promenade, rooftop dinner." },
      { day: 7, title: "Farewell", body: "Transfer to Bandaranaike International Airport." },
    ],
  },
  {
    slug: "canton-fair-tour",
    title: "Canton Fair Group Tour",
    destination: "China",
    destinationSlug: "china",
    nights: 5,
    price: 46500,
    ...
    image: "/images/Tourist-Visas/china-tourist.png",
    summary:
      "Six days built around the world's largest trade fair in Guangzhou — visa support, hotel near the fairgrounds, guided fair navigation, and a Pearl River city tour.",
    inclusions: [
      "Hotel near Guangzhou International Convention Centre (5 nights)",
      "Canton Fair registration & badge support",
      "Group airport pickups and drop-offs",
      "Guangzhou city half-day tour",
      "Daily breakfast",
    ],
    itinerary: [
      { day: 1, title: "Group Arrival", body: "Group airport pickup, hotel check-in, briefing dinner." },
      { day: 2, title: "Canton Fair — Day 1", body: "Guided fair orientation, priority halls walk-through." },
      { day: 3, title: "Canton Fair — Day 2", body: "Free time at the fair, optional factory visit." },
      { day: 4, title: "Canton Fair — Day 3", body: "Final fair sessions, supplier meeting support." },
      { day: 5, title: "Guangzhou City Tour", body: "Shamian Island, Chen Clan Hall, Pearl River evening cruise." },
      { day: 6, title: "Farewell", body: "Breakfast, group transfer to Guangzhou Baiyun Airport." },
    ],
  },
];
...
export type DestinationCategory = "International" | "Domestic" | "Honeymoon" | "Group" | "Adventure" | "Romantic";
...
export const destinationCategories: Record<string, DestinationCategory[]> = {
  ...
  nepal: ["International", "Adventure"],
  bhutan: ["International", "Honeymoon"],
  maldives: ["International", "Honeymoon", "Romantic"],
};
