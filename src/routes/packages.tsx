...
export const Route = createFileRoute("/packages")({
  head: () => ({
    meta: [
      { title: "Journeys — Upscale Travels Pvt. Ltd." },
      { name: "description", content: "Signature itineraries designed by Upscale Travels Pvt. Ltd. specialists — cultural, adventure, romantic, and family journeys across six continents." },
      { property: "og:title", content: "Journeys — Upscale Travels Pvt. Ltd." },
      { property: "og:description", content: "Signature itineraries designed by Upscale Travels Pvt. Ltd. specialists." },
    ],
  }),
