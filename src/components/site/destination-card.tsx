  ...
  return (
    ...
    >
      <Link
        ...
        className="group block rounded-3xl overflow-hidden bg-card card-elevated hover-lift"
      >
        <div className="relative aspect-[4/5] overflow-hidden">
          ...
          <div className="absolute inset-x-0 bottom-0 p-6 text-primary-foreground text-center">
            ...
            <p className="mt-1 text-sm text-primary-foreground/85 line-clamp-2">{dest.tagline}</p>
          </div>
